...
public class SROAdapter extends RecyclerView.Adapter<SROAdapter.ViewHolder> {
    private ArrayList items;
    private int itemLayout;
    private Context context;
    HashMap hm;

    public SROAdapter   (ArrayList items, Context context) {
        this.items = items;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.sro_task_layout, viewGroup, false);
...
//            id = itemView.findViewById(R.id.txttaskid);
            ...
            address = itemView.findViewById(R.id.show_srooffice);
            mobile = itemView.findViewById(R.id.showbankname);
            meeting_time = itemView.findViewById(R.id.show_srodate);
            remark = itemView.findViewById(R.id.show_sroamount);
